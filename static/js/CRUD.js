...
var column2 = new dv.GridColumn("Appointment Type");
column2.dataType = dv.StringType;
column2.caption = "Appointment Type";
columns.push(column2);

var column3 = new dv.GridColumn("status");
column3.dataType = dv.LookupType;
column3.caption = "Appointment Status";
column3.metaData.set("values", states.map(s => [s["Name"]]));
columns.push(column3);

var column4 = new dv.GridColumn("Research Protocol");
column4.dataType = dv.DateType;
column4.caption = "Research Protocol";
...
var column5 = new dv.GridColumn("Provider");
column5.dataType = dv.IntegerType;
column5.caption = "Provider";
...
// set the model
grid.model = new dv.ArrayModel(list_items, columns, "index");
...
function setEditMode()
{
    ...
    grid.getRowElement(editRow).style.outline = "#4CAF50 solid 1px";
}
