...
Object(function webpackMissingModule() { var e = new Error("Cannot find module '@fullcalendar/core/styles/main.css'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
Object(function webpackMissingModule() { var e = new Error("Cannot find module '@fullcalendar/daygrid/styles/main.css'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
Object(function webpackMissingModule() { var e = new Error("Cannot find module '@fullcalendar/timegrid/styles/main.css'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
Object(function webpackMissingModule() { var e = new Error("Cannot find module '@fullcalendar/list/styles/main.css'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
document.addEventListener('DOMContentLoaded', function () {
  var grid = gridstack__WEBPACK_IMPORTED_MODULE_0__.GridStack.init({
    cellHeight: 250,
    draggable: {
      handle: '.grid-stack-item-content'
    },
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var resultsTable = document.getElementById('patient-results-table');
  var resultsBody = document.getElementById('patient-results-body');
  var noResultsMsg = document.getElementById('no-results-msg');
  form.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(e) {
      var params, response, patients, _t;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            ...
            _context.p = 1;
            _context.n = 2;
            return fetch("/api/patients?".concat(params.toString()));
          case 2:
            response = _context.v;
            if (response.ok) {
              _context.n = 3;
          ...
          case 4:
            ...
            if (patients.length === 0) {
              ...
              patients.forEach(function (p) {
                ...
                row.innerHTML = "\n            <td>".concat(p.mrn, "</td>\n            <td>").concat(p.greek_fname || '', "</td>\n            <td>").concat(p.greek_lname || '', "</td>\n            <td>").concat(p.fname, "</td>\n            <td>").concat(p.lname, "</td>\n            <td>").concat(p.dob || '', "</td>\n            <td>").concat(p.phone || '', "</td>\n            <td>").concat(p.email || '', "</td>\n            <td>").concat(p.amka || '', "</td>\n          ");
          ...
          case 5:
            _context.p = 5;
            _t = _context.v;
            console.error('Error fetching patient data:', _t);
            resultsTable.style.display = 'none';
